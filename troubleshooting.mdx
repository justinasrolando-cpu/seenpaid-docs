...
<Steps>
  ...
  <Step title="Check whether it's gated today">
    **Instagram and Facebook** connect only for accounts added to seenpaid's Meta app, because Meta App Review has not passed; contact support from the dashboard if you'd like yours added. **Pinterest** connects but publishing currently fails on Pinterest's side (Trial access). **Reddit and VK** aren't available yet. Everything else connects today; see [Supported platforms](/guides/platforms).
  </Step>
